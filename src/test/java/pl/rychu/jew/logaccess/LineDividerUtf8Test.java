...
public class LineDividerUtf8Test {
	...
	private List<Object[]> parameters() {
		...
		result.add($(li(buf(0x41), buf(0xc5), buf(0x0d, 0x0a, 0x0d), buf(0x49, 0x02), buf(0x0a, 0x61))
		 , evs(bytes(0x41), bytes(0xc5), 0, 4, bytes(0x49, 0x02), 5, bytes(0x61))));
		result.add($(li(buf(0x41), buf(0xc5), buf(0x0d, 0x0a), buf(0x0d, 0x49, 0x02), buf(0x0a, 0x61))
		 , evs(bytes(0x41), bytes(0xc5), 0, 4, bytes(0x49, 0x02), 5, bytes(0x61))));

		// aaa
		result.add($(li(buf(0x41), buf(0xc5), buf(0x0a, 0x0a), buf(0x0a, 0x49, 0x02), buf(0x0a, 0x61))
		 , evs(bytes(0x41), bytes(0xc5), 0, 3, 4, bytes(0x49, 0x02), 5, bytes(0x61))));
		result.add($(li(buf(0x41), buf(0xc5, 0x0a), buf(0x0a), buf(0x0a, 0x49, 0x02), buf(0x0a, 0x61))
		 , evs(bytes(0x41), bytes(0xc5), 0, 3, 4, bytes(0x49, 0x02), 5, bytes(0x61))));
		// aad
		result.add($(li(buf(0x41), buf(0xc5), buf(0x0a, 0x0a), buf(0x0d, 0x49, 0x02), buf(0x0a, 0x61))
		 , evs(bytes(0x41), bytes(0xc5), 0, 3, 4, bytes(0x49, 0x02), 5, bytes(0x61))));
		result.add($(li(buf(0x41), buf(0xc5, 0x0a), buf(0x0a), buf(0x0d, 0x49, 0x02), buf(0x0a, 0x61))
		 , evs(bytes(0x41), bytes(0xc5), 0, 3, 4, bytes(0x49, 0x02), 5, bytes(0x61))));
		// ada
		result.add($(li(buf(0x41), buf(0xc5), buf(0x0a, 0x0d), buf(0x0a, 0x49, 0x02), buf(0x0a, 0x61))
		 , evs(bytes(0x41), bytes(0xc5), 0, 3, bytes(0x49, 0x02), 5, bytes(0x61))));
		result.add($(li(buf(0x41), buf(0xc5, 0x0a), buf(0x0d), buf(0x0a, 0x49, 0x02), buf(0x0a, 0x61))
		 , evs(bytes(0x41), bytes(0xc5), 0, 3, bytes(0x49, 0x02), 5, bytes(0x61))));
		// add
		result.add($(li(buf(0x41), buf(0xc5), buf(0x0a, 0x0d), buf(0x0d, 0x49, 0x02), buf(0x0a, 0x61))
		 , evs(bytes(0x41), bytes(0xc5), 0, 3, 4, bytes(0x49, 0x02), 5, bytes(0x61))));
		result.add($(li(buf(0x41), buf(0xc5, 0x0a), buf(0x0d), buf(0x0d, 0x49, 0x02), buf(0x0a, 0x61))
		 , evs(bytes(0x41), bytes(0xc5), 0, 3, 4, bytes(0x49, 0x02), 5, bytes(0x61))));

		// daa
		result.add($(li(buf(0x41), buf(0xc5), buf(0x0d, 0x0a), buf(0x0a, 0x49, 0x02), buf(0x0a, 0x61))
		 , evs(bytes(0x41), bytes(0xc5), 0, 4, bytes(0x49, 0x02), 5, bytes(0x61))));
		result.add($(li(buf(0x41), buf(0xc5, 0x0d), buf(0x0a), buf(0x0a, 0x49, 0x02), buf(0x0a, 0x61))
		 , evs(bytes(0x41), bytes(0xc5), 0, 4, bytes(0x49, 0x02), 5, bytes(0x61))));
		// dad
		result.add($(li(buf(0x41), buf(0xc5), buf(0x0d, 0x0a), buf(0x0d, 0x49, 0x02), buf(0x0a, 0x61))
		 , evs(bytes(0x41), bytes(0xc5), 0, 4, bytes(0x49, 0x02), 5, bytes(0x61))));
		result.add($(li(buf(0x41), buf(0xc5, 0x0d), buf(0x0a), buf(0x0d, 0x49, 0x02), buf(0x0a, 0x61))
		 , evs(bytes(0x41), bytes(0xc5), 0, 4, bytes(0x49, 0x02), 5, bytes(0x61))));
		// dda
		result.add($(li(buf(0x41), buf(0xc5), buf(0x0d, 0x0d), buf(0x0a, 0x49, 0x02), buf(0x0a, 0x61))
		 , evs(bytes(0x41), bytes(0xc5), 0, 3, bytes(0x49, 0x02), 5, bytes(0x61))));
		result.add($(li(buf(0x41), buf(0xc5, 0x0d), buf(0x0d), buf(0x0a, 0x49, 0x02), buf(0x0a, 0x61))
		 , evs(bytes(0x41), bytes(0xc5), 0, 3, bytes(0x49, 0x02), 5, bytes(0x61))));
		// ddd
		result.add($(li(buf(0x41), buf(0xc5), buf(0x0d, 0x0d), buf(0x0d, 0x49, 0x02), buf(0x0a, 0x61))
		 , evs(bytes(0x41), bytes(0xc5), 0, 3, 4, bytes(0x49, 0x02), 5, bytes(0x61))));
		result.add($(li(buf(0x41), buf(0xc5, 0x0d), buf(0x0d), buf(0x0d, 0x49, 0x02), buf(0x0a, 0x61))
		 , evs(bytes(0x41), bytes(0xc5), 0, 3, 4, bytes(0x49, 0x02), 5, bytes(0x61))));
